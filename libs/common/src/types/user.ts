...
export interface UserServiceClient {
  ...
  getUserByUserId(request: GetUserByUserIdRequest): Observable<GetUserByUserIdResponse>;
...
export interface UserServiceController {
  ...
  getUserByUserId(request: GetUserByUserIdRequest): Promise<GetUserByUserIdResponse> | Observable<GetUserByUserIdResponse> | GetUserByUserIdResponse;
  ...
  getUsersByIds(request: GetUsersByIdsRequest): Promise<GetUsersByIdsResponse> | Observable<GetUsersByIdsResponse> | GetUsersByIdsResponse;
