...
import { HealthRequest, HealthResponse } from './auth';
...
// Health interfaces imported at top of file
...
export interface UserServiceClient {
  ...
  ): Observable<GetUserByAuthUserIdResponse>;
  updateUserProfile(
  ...
  ): Observable<DeactivateUserResponse>;
  updateLastLogin(
    request: UpdateLastLoginRequest,
  ): Observable<UpdateLastLoginResponse>;
  ...
  ): Observable<GetUsersByAuthUserIdsResponse>;
  getUserProfile(
    request: GetUserByAuthUserIdRequest,
  ): Observable<GetUserByAuthUserIdResponse>;
